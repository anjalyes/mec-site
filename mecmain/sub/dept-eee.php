      ...
      <div class="tabtable tabs-left clearfix">
        ...
        <div id="myTabContent" class="tab-content">
          <div id="about" class="tab-pane fade active in">
            ...
            <p>The department of Electrical Engineering started in the year 2009, offers a vivacious environment for graduate educations in Electrical and Electronic Engineering. It is one of the developed and well equipped departments in the institution. The vision of the department is to provide the leadership to achieve excellence in the field of Electrical Engineering and to create technical manpower of global standards as Electrical Engineering with capabilities of accepting new challenges.</p>
            <p>The department is committed to the advancement of the frontiers of knowledge in Electrical Engineering and to provide the students with a stimulating and rewarding learning experience. The department is dedicated to impart quality and value based education to increase satisfaction level of all stake holders.</p>

            <h4 class="deptcont line">Objectives</h4><br>
            <ul>
              <li>To mould competent Electrical Engineers capable of providing dynamic leadership in various walks of life and to cater the needs of R&D, industry, business and community. </li>
              <li>To develop professional Engineers of high quality both in software and hardware.</li>
              <li>To provide opportunities to come up with real time solutions to challenging problems. </li>
          ...
          <div id="hod" class="tab-pane fade">
            ...
            <br/>
            <p>14 years of experience in taking classes and guiding projects </p>
            <div class="hod line"><h4>Subjects Handling</h4></div>
            <br />
            <p>Power Electronics<br/>
            Control Systems Engg<br/>
            Control Systems Engg<br/>
            Network Theory<br/>
           Electrical Technology<br/>
            ...
            <br/>
            <p>Soft computing techniques in the field of Sensorless vector control of AC drives </p>
            <div class="hod line"><h4>Contact Details</h4></div>
            <br/>
            <p>Associate Professor &amp; HOD, Department of Electrical Engg.,<br/>
            Model Engg. College, Thrikkakkara,<br/>
            Cochin 682021, Kerala,<br/>
           04842575370 (305), +918547310981. <br>
            hodee@mec.ac.in
            </p>
          </div>
          ...
          <div id="facilities" class="tab-pane fade" >
            ...
            <div>
              ...
              <ul >
                ...
                <li>Advanced Electrical lab- with Mi-Power simulation software</li>
              </ul>
              <br>
            </div> 
            ...
            <div><br>
              ...
              <ul>
                 <li>15kW, 220V DC generator</li>
                  <li>3.7kW component motor</li>
                   <li>3.7kW series motor</li>
                    <li>3.7kW shunt motor</li>
                     <li>3.7kW DC component generator</li>
                      <li>3.7kW squirrel cage induction motor</li>
                       <li>400/440V 3kVA transformers</li>
                        <li>220/110V 3kVA transformers</li>
                         <li>1phi and 3phi Auto transformers of various ratings</li>
              </ul>
              <br>
            </div>
          </div>
          ...
          <div id="associations" class="tab-pane fade">
            ...
            <p>EMF also takes initiative in organising Industrial Visits for students of electrical and electronics department, in which the latest visit to Kudankulam Nuclear Power Plant has raised the morale of the club among the students.</p>
