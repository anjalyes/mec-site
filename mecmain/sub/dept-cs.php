      ...
      <div class="mypanel">
        ...
        <div id="myTabContent" class="tab-content">
          <div id="about" class="tab-pane fade active in">
            ...
            <ul>
              <li>To provide every student with a strong conceptual foundation in the core areas of Computer Science.
              </li>
              <li>To enable students to engineer ingenious computing hardware and software solutions with the greatest degree of accuracy, flexibility and based on the latest engineering paradigms.</li>
              <li>To familiarize students with the latest in software and programming tools.</li>
              <li>To provide the greatest amount of pragmatism in approaching an engineering solution.</li>
              <li>To provide students with hands-on engineering experience through laboratory courses and project.</li>
              <li>    To coach students to work in teams and provide insight and direction into the atmosphere as might be encountered by professionals in the field.
          ...
          <div id="facilities" class="tab-pane fade" >
            <h4 class="deptcont line">Facilities</h4>
            <div>
              
              <ul >
                <li>`MEC has excellent infrastructural facilities and well maintained laboratories.</li>
                <li>The Computer Science department is provided with 2 Software Development labs networked entirely and connected to Internet via a 64kbps RF link to VSNL, providing us with 24 hour internet connectivity.</li>
                <li>There are 150 computers with varying processing powers from 500Hz to 2.5GHz running Linux and Windows and 1 Sun Ultra Sparc Server running Solaris OS.</li>
                <li>Thin clients based on Linux Terminal Server Project(LTSP) with both Pentium based PCs and Sparc based java boxes as clients.</li>
                <li>Small Beowulf cluster and a few of our lab computers run openMosix clustering.</li>
                <li>Grid computing is implemented in our labs.</li>
                <li>We Host our own Web Server, FTP Server and Mail Server powered by Debian. Our lab is equipped with a SGI workstation, a RAID array, an Apple pc and a GPS which is a part of our GIS lab.</li>
                <li>The only college in Kerala to have labs with CUDA, a parallel computing architecture developed by NVIDIA.</li>
                <li>Lab which contains the Dual Processor Industry Standard Blade Server containing 6 Server Blades with clusters running Hadoop and Sector/Sphere and 8 64bit(or Dual) Processor Rack Mounted Server in addition to 3 IBM X series servers.</li>
                <li>Two Graphics processing units (GPUs) are being used - Tesla C2070 and GeForce GTX480.</li>
                <li>Wi-Fi Hotspots are installed in the campus.</li>
                <li>    The college offers good video conferencing facilities.
</li>
            ...
            <h4 class="line">Advanced Computing Lab</h4> 
           ...
           <h4 class="line">Microprocessor lab</h4> 
           ...
           <h4 class="line">Computer Hardware Lab</h4> 
...
Computer Graphics lab, Image Processing Lab etc are some of the resources under this department.</p>       
          ...
          <div id="achievements" class="tab-pane fade" >
            ...
            <ul style="list-style-type:none;">
              <li><span style="font-weight:400;">Optimizing C compiler for .NET</span><br/> 
              ...
              <li><span style="font-weight:400;">BIOCLUSTERS- Role of Cluster Computing in Bioinformatics</span><br/> 
              ...
              <li><span style="font-weight:400;">32 Bit Operating System</span><br/> 
              The project is an attempt to build a 32 bit protected mode operating system based on the UNIX Kernel architecture.</li><br>
              <li><span style="font-weight:400;">High Performance Cluster Computing - "SRISHTI" </span><br/> 
              ...
              <li><span style="font-weight:400;">Spam Filtering Using Spam Mail Communities </span><br/>
              ...
              <li><span style="font-weight:400;">Specialization Scores For Asymmetric Web Search Queries </span><br/>
             This is an approach to compute the specialization score for search queries, the aim of the score being to indicate how specialized the narrow topic is, to the broader topic.The approach generates scores for such queries, which can further be used to refine web searches for such queries, provided a given query could be identified to be of the form that we deal with.</li><br>
              <li><span style="font-weight:400;">Context Disambiguation in Web Search Results </span><br/>
            ...
            <ul>
              <li>Mr. Shan Kadavil of the 1999 batch heads the India operations for the Zynga game networks, the world's largest social networking gaming company.</li>
              <li>Mr. Sreeraj S of the 1993 batch is the founder of Ordyn technologies and is currently the CTO of the company.</li>
              <li>Mr.Sarath Lakshman of the 2011 batch is the author of 'Shell Scripting Cookbook'. He also holds credit as the developer of SLYNUX, (www.slynux.org) a user friendly GNU/Linux distribution.</li>
              <li>Mr Murali Krishna P of 1996 batch is the co-author of Multifractal Based Network Traffic Modelling.</li>
              <li>Mr. Jacob Cherian of 1994 batch has 9 authorised patents to his credit on RAID technology.</li> 
              <li>Cherian Thomas of 2006 batch was the Yahoo HackDay (2007) awardee for "Social Routing", a Yahoo Maps web application. Bibin Mathew, Binu Mathew, Hareesh R, Rajesh R and Sujay S of 1999 batch won the "National award for best B.Tech Project-98" from ISTE.</li>
              <li>MECians have been a part of GSoC for the past four years and this time Anurup Raveendran (2011 batch) and Arun Scaria (2012 batch) got selected for the prestigious event.</li>
              <li>Jacob Cherian of 1994 batch was selected as the Dell Inventor of the year in 2005.</li>
              <li>Premy Varghese of 1999 batch won the Maestro award for the best project management in Wipro.</li>
              <li>Rupesh Kumar R of 1997 batch won the Individual Excellence award in Infosys.</li>
              <li>Roshan James and Pooja Malpani, of 2002 Batch, were recipients of "Microsoft's Most Valuable Professional" award in 2003 and 2004.</li>
              <li>Sony Jose of 2007 batch won the first prize in the National Level Wipro Code Zap Guru Contest in 2007.</li>
              <li>Students from MEC brought laurels to the state when they finished runners up in the Microsoft Technical Fest. The event was held on a National level and served as a platform to showcase their latest offering in the world of IT called .NET in the year 2002.</li>
              <li>Preetish M Kumar filed 3 patents on image processing.</li>
